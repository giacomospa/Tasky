<x-layout>
    ...
    <section class="container" id="hero">
        <div class="row">
            <div class="col d-flex flex-column align-items-center justify-content-center hero-content mt-5">
                <h1 class="display-3 text-center" data-aos="fade-right" data-aos-duration="1300">Benvenuto su <span class="title-custom">Tasky</span></h1>
                <p class="lead text-center" data-aos="zoom-in" data-aos-duration="1500">Connetti Aziende e Freelance tech con un click 🚀</p>
                <div data-aos="fade-left" data-aos-duration="1300" class="scroll-down" id="arrow">
    ...
    <section class="container py-5" id="aboutUs">
        <div class="row align-items-center">
            <div class="col-12 col-md-6 d-flex flex-column" data-aos="zoom-in" data-aos-duration="1300">
            ...
            <div class="col-12 col-md-6 justify-content-center d-flex" data-aos="zoom-in" data-aos-duration="1300">
                <img class="team-img shadow-custom img-fluid w-75" src="/media/teamwork.jpeg" alt="Team Work">
            </div>
        </div>
    </section>
</x-layout>
