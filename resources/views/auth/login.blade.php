<x-layout>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col d-flex justify-content-center mt-5" data-aos="fade-right" data-aos-duration="1300">
                <div class="card card-auth shadow-lg border-0 rounded-4" style="width: 50%;">
                    <div class="card-body card-body-auth">
                        <form  method="POST" action="{{route("login")}}">
                            ...
                            <h5 class="lead fs-6 d-flex justify-content-end mt-2">Non hai ancora un account? <a class="text-color text-decoration-none ms-1" href="{{route('register')}}">Registrati</a></h5>
                        </form>
                    </div>
                </div>
            </div>
